...
- [ ] **Phase 1** — PortWatch ingestion (`ingest/portwatch.py`) — no key required. Exit: chokepoint6 collapse table for last 200 days.
- [ ] **Phase 2** — GDELT ingestion (`ingest/gdelt.py`) + hand-built reference CSVs (`data/reference/`) — no key required.
